...
Public Class frmTreeTraversalQuiz
    ...
    Private Sub btnGuessA_Click(sender As Object, e As EventArgs) Handles btnGuessA.Click
        ...
        'checks answer and returns results
    ...
    Sub selectingInfoNeeded()
        ...
        Dim selectingCorrectQuestionsID As String = "SELECT TreeTraversalQuestionID FROM TreeTraversalQuizResult WHERE TreeTraversalCorrect=Yes AND UserID=@userID"
        Dim selectingWrongQuestionsID As String = "SELECT TreeTraversalQuestionID FROM TreeTraversalQuizResult WHERE TreeTraversalCorrect=No AND UserID=@userID;"
    ...
    Sub selectingQuestions()
        ...
        For i = 0 To totalNumberOfWrongQuestions() - 1
            ...
            Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
            Dim selectingWrongQuestions As String = "SELECT (TreeTraversalQuestions.TreeTraversalQuestion) FROM TreeTraversalQuestions WHERE TreeTraversalQuestionID = @question"
    ...
    Sub selectingMoreQuestionsNeeded()
        ...
        If usedQuestionsTotal < 10 And numberOfMoreQuestionsNeeded <= totalNumberOfCorrectQuestions() Then
            For i = 0 To numberOfMoreQuestionsNeeded - 1
                ...
                Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
                Dim selectingCorrectQuestions As String = "SELECT (TreeTraversalQuestions.TreeTraversalQuestion) FROM TreeTraversalQuestions WHERE TreeTraversalQuestionID = @questions"
    ...
    Sub questionAnswerChoicesWrong()
        ...
        For i = 0 To totalNumberOfWrongQuestions() - 1
            currentQuestionId = wrongQuestionIDArray(i)
            Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
            Dim selectingPossibleAnswersWrong As String = "SELECT (TreeTraversalAnswers.PossibleAnswer) FROM TreeTraversalAnswers WHERE TreeTraversalQuestionID = @question"
    ...
    Sub questionAnswerChoicesCorrect()
        ...
        For i = 0 To totalNumberOfCorrectQuestions() - 1
            currentQuestionId = correctQuestionIDArray(i)
            Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
            Dim selectingPossibleAnswersCorrect As String = "SELECT (TreeTraversalAnswers.PossibleAnswer) FROM TreeTraversalAnswers WHERE TreeTraversalQuestionID = @question"
    ...
    Function totalNumberOfCorrectQuestions()
        Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
        Dim selectingNumberOfCorrectQuestions As String = "SELECT *  FROM TreeTraversalQuizResult WHERE TreeTraversalCorrect=Yes AND UserID=@userId;"
    ...
    Function totalNumberOfWrongQuestions()
        Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
        Dim selectingNumberOfWrongQuestions As String = "SELECT *  FROM TreeTraversalQuizResult WHERE TreeTraversalCorrect=No AND UserID=@userId;"
    ...
    Function checkAnswer()
        ...
        If currentQuestion <= noOfWrongQuestions Then
            ...
            Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
            Dim selectingWrongAnswer As String = "SELECT (TreeTraversalAnswers.PossibleAnswer) FROM TreeTraversalAnswers WHERE TreeTraversalQuestionID = @question AND Correct=Yes"
        ...
        ElseIf currentQuestion > noOfWrongQuestions Then
            ...
            Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
            Dim selectingCorrectAnswer As String = "SELECT (TreeTraversalAnswers.PossibleAnswer) FROM TreeTraversalAnswers WHERE TreeTraversalQuestionID = @question AND Correct=Yes"
    ...
    Function updatingTableCorrect()
        Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
        Dim updatingCorrect As String = "UPDATE TreeTraversalQuizResult SET TreeTraversalCorrect=Yes WHERE UserId=@userID AND TreeTraversalQuestionID=@questionID"
    ...
    Function updatingTableWrong()
        Dim connectToLoginDB As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Login_Database.accdb")
        Dim updatingWrong As String = "UPDATE TreeTraversalQuizResult SET TreeTraversalCorrect=No WHERE UserId=@userID AND TreeTraversalQuestionID=@questionID"
